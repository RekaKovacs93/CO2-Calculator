...
const MetersForm = ({creatInstance}) => {
    ...
    return (
        <form onSubmit = {handleSubmit}>
            <div>
                ...
                <input type = 'number' value = {electric} onChange = {handleElectricChange } id = "electric" style={{width: sizeInput}}/>
                <label htmlFor = "gas" >gas bill</label>
                <input type = "number" value = {gas} onChange = {handleGasChange} id = "gas" style={{width: sizeInput}}/>
                <label htmlFor = "oil">oil bill</label>
                <input type = "number" value = {oil} onChange = {handleOilChange} id = "oil"  style={{width: sizeInput}}/>
            </div>
            <div>
                <label htmlFor = "mileage">mileage of on your car</label>
                <input type = "number" value = {mileage} onChange = {handleMileageChange} id = "mileage"  style={{width: sizeInput}}/>
                <label htmlFor = "flightUnder" >flights under 4 hours</label>
                <input type = "number" value = {flightUnder} onChange = {handleFlightUnderChange} id = "flightUnder" style={{width: sizeInput}}/>
                <label htmlFor = "flightOver" >flights over 4 hours</label>
                <input type = "number" value = {flightOver} onChange = {handleFlightOverChange} id = "flightOver" style={{width: sizeInput}}/>
            </div>
            <div>
                <label htmlFor = "newspaper">recycle newspaper</label>
                <input type = "checkbox" id = "newspaper" onChange = {handleNewspaperChange} value = {newspaperRecycle} checked = {newspaperRecycle}/>
                <label htmlFor = "tin" >recycle aluminum and tin</label>
                <input type = "checkbox" id = "tin" onChange = {handleTinChange} value = {tinRecycle} checked = {tinRecycle}/>
            </div>
